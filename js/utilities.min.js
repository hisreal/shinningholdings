  ...
  init() {
    ...
    window.addEventListener("scroll", () => {
      if (window.scrollY > this.threshold) {
        // make header sticky and visible
        navbar.classList.add("sticky-nav", "active");
      } else {
        // back to normal position at top of page
